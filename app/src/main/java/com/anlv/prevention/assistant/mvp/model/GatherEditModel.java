 ...
 */
@ActivityScope
public class GatherEditModel extends BaseModel implements GatherEditContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    GatherEditModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResult<Gather>> updateGather(String id, String areaId, String name, String phoneNumber, String remark) {
        return mRepositoryManager.obtainRetrofitService(CommonService.class)
                .updateGather(id, areaId, name, phoneNumber, remark);
    }
}