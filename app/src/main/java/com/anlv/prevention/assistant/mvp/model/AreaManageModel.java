 ...
 */
@ActivityScope
public class AreaManageModel extends BaseModel implements AreaManageContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    AreaManageModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResult<List<Area>>> queryArea() {
        return mRepositoryManager.obtainRetrofitService(CommonService.class)
                .queryArea();
    }

    @Override
    public Observable<BaseResult<String>> delArea(String id) {
        return mRepositoryManager.obtainRetrofitService(CommonService.class)
                .delArea(id);
    }
}