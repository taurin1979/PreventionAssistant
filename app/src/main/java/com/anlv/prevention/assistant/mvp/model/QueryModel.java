...
public class QueryModel extends BaseModel implements QueryContract.Model {
    ...
    @Inject
    QueryModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResult<List<Info>>> queryRecent(String certificateNumber) {
        return mRepositoryManager.obtainRetrofitService(CommonService.class)
                .queryRecent(certificateNumber);
    }
}