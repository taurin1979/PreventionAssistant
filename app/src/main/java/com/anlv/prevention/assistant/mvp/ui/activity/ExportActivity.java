...
public class ExportActivity extends BaseActivity<ExportPresenter> implements ExportContract.View {
    ...
    @BindView(R.id.export_start_time_et)
    ...
    @OnClick(R.id.export_start_time_et)
    void onStartTimeClicked() {
        TimePickerView pickerView = new TimePickerBuilder(this, (date, v) -> etStartTime.setText(TimeUtils.date2String(date, TIME_PATTERN)))
    ...
    void onQueryClicked(View view) {
        ...
        mPresenter.query(startTime, endTime);
    }
}
