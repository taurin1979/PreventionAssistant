...
import com.anlv.prevention.assistant.mvp.model.GatherEditModel;
 ...
 * ================================================
 */
public interface GatherEditContract {
    ...
    interface Model extends IModel {
        /**
         * 采集员添加
         * {@link GatherEditModel#updateGather(String, String, String, String, String)}
         */
        Observable<BaseResult<Gather>> updateGather(String id,
                                                    String areaId,
                                                    String name,
                                                    String phoneNumber,
                                                    String remark);
